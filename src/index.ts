...
.status-indicator{font-size:1.4rem;font-weight:700;color:#e0e0e0;border-bottom:2px solid ${status==='all_green'?'var(--green)':status==='mostly_up'?'var(--yellow)':'var(--red)'};margin-bottom:4px}
